...
export type RequiredKeys<P> = { [K in keyof P]: P[K] extends OptionalType<any> ? never : K }[keyof P]

export type OptionalKeys<P> = { [K in keyof P]: P[K] extends OptionalType<any> ? K : never }[keyof P]
